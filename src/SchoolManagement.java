				...
				while (teachersRepeat) {
					...
					case "5": // new teacher
						...
						for (int i = 0; i < numberOfSubjects; i++) {
							...
							//proba
							System.out.println(teacher.getSubjects().get(i));
					...
					case "6":
						...
						System.out.println("Enter a subject to find a teacher ");
						System.out.println(school.findTeacherIDBySubject(sc.next()));
						sc.nextLine();
						
						break;
					case "7":
						
						System.out.println("Enter a studentID to find the tutor");
						
						System.out.println(school.findTutorID(sc.next()));
						break;
			...
			case "3":
				...
				while (studentsRepeat) {
					...
					case"8":
						...
						System.out.println("Enter the the teacherID to find the students");
						
						System.out.println(school.getStudentsByTeacherID(sc.next()));
						sc.nextLine();
